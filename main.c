...
#define RANGE 250							// Range of values for arrays initialization (1 to RANGE)
#define R_ROWS 50000							// Number of rows for R array
#define S_ROWS 30000							// Number of rows for S array
